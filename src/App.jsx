...
function App() {
  ...
  return (
    <div className='App'>
          ...
          {list.map((value, index)=>{
            return(
              ...
              <div className='tareas'>
                <p id='tarea' key={index}>{value}</p>
                
                <button className='todo btn btn-primary mt-1' onClick={() => dispatchList(Todo())}>{}</button>
      ...
      <br />
      <button className='btn btn-primary' onClick={() => dispatchList(putList(document.getElementById("tasca")))} >afegir tasca</button>
      <br />
